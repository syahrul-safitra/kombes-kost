                ...
                <div class="registration-body">
                    ...
                    <form id="registrationForm" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="error-message" id="namaLengkapError">Nama lengkap harus diisi</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" class="form-control" id="noWa" placeholder="812-3456-7890"
                                    required>
                            </div>
                            <div class="error-message" id="noWaError">Nomor WhatsApp tidak valid</div>
                        </div>

                        <!-- Status -->
                        <div class="mb-3">
                            <label for="status" class="form-label">
                                <i class="bi bi-briefcase-fill"></i> Status
                            </label>
                            ...
                            <div class="error-message" id="statusError">Status harus dipilih</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="error-message" id="konfirmasiPasswordError">Password tidak cocok</div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="terms">
                                    Saya setuju dengan <a href="#" style="color: var(--pink-primary);">Syarat &
                                        Ketentuan</a> dan <a href="#"
                                        style="color: var(--pink-primary);">Kebijakan Privasi</a>
                                </label>
                            </div>
                            <div class="error-message" id="termsError">Anda harus menyetujui syarat dan ketentuan
                            </div>
                        </div>
